...
function plot_G_renormalized_results(t, results, det_result, params, R0)
    ...
    % Plot R1 (G-renormalized standard deviation for susceptible) - Linear Scale
    ...
    saveas(gcf, sprintf('SIHRS_R1_Susceptible_Linear_R0_%.2f.png', R0));
    
    % Plot R1 (G-renormalized standard deviation for susceptible) - Log Scale
    ...
    grid on;
    legend(legend_labels, 'Location', 'best');
    saveas(gcf, sprintf('SIHRS_R1_Susceptible_Log_R0_%.2f.png', R0));
    ...
    % Plot R4 (G-renormalized standard deviation for recovered) - Linear Scale
    ...
    grid on;
    legend(legend_labels, 'Location', 'best');
    saveas(gcf, sprintf('SIHRS_R4_Recovered_Linear_R0_%.2f.png', R0));
    
    % Plot R4 (G-renormalized standard deviation for recovered) - Log Scale
    ...
    grid on;
    legend(legend_labels, 'Location', 'best');
    saveas(gcf, sprintf('SIHRS_R4_Recovered_Log_R0_%.2f.png', R0));
    
    % Plot R5 (G-renormalized standard deviation for dead) - Linear Scale
    ...
    grid on;
    legend(legend_labels, 'Location', 'best');
    saveas(gcf, sprintf('SIHRS_R5_Dead_Linear_R0_%.2f.png', R0));
    
    % Plot R5 (G-renormalized standard deviation for dead) - Log Scale
    ...
    grid on;
    legend(legend_labels, 'Location', 'best');
    saveas(gcf, sprintf('SIHRS_R5_Dead_Log_R0_%.2f.png', R0));
    ...
    fprintf('  - SIHRS_R1_Susceptible_Linear_R0_%.2f.png\n', R0);
    fprintf('  - SIHRS_R1_Susceptible_Log_R0_%.2f.png\n', R0);
    fprintf('  - SIHRS_R2_Infected_Linear_R0_%.2f.png\n', R0);
    fprintf('  - SIHRS_R2_Infected_Log_R0_%.2f.png\n', R0);
    fprintf('  - SIHRS_R3_Hospitalized_Linear_R0_%.2f.png\n', R0);
    fprintf('  - SIHRS_R3_Hospitalized_Log_R0_%.2f.png\n', R0);
    fprintf('  - SIHRS_R4_Recovered_Linear_R0_%.2f.png\n', R0);
    fprintf('  - SIHRS_R4_Recovered_Log_R0_%.2f.png\n', R0);
    fprintf('  - SIHRS_R5_Dead_Linear_R0_%.2f.png\n', R0);
    fprintf('  - SIHRS_R5_Dead_Log_R0_%.2f.png\n', R0);
    fprintf('  - SIHRS_G_renormalized_std_dev_R0_%.2f_combined.png\n', R0);
    fprintf('  - SIHRS_G_renormalized_std_dev_R0_%.2f_combined_LOG.png\n', R0);
