%% Figure 2: Single Stochastic Paths
...
for k = 1:length(res)
    ...
    legend('Location', 'northeast', 'Interpreter', 'latex', 'FontSize', 40);
    set(gca, 'LooseInset', get(gca,'TightInset'), 'FontSize', 30);
    saveas(gcf, sprintf('stoch_N%d_sr.png', Nvals(k)));
end
...
for k = 1:length(res)
    ...
    legend('Location', 'northeast', 'Interpreter', 'latex', 'FontSize', 40);
    set(gca, 'LooseInset', get(gca,'TightInset'), 'FontSize', 30);
    saveas(gcf, sprintf('stoch_N%d_id.png', Nvals(k)));
end
...
for k = 1:length(res)
    ...
    legend('Location', 'northeast', 'Interpreter', 'latex', 'FontSize', 40);
    set(gca, 'LooseInset', get(gca,'TightInset'), 'FontSize', 30);
    saveas(gcf, sprintf('stoch_N%d_h.png', Nvals(k)));
end
