...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    hold on;
    for idx = 1:length(params.N_values)
        plot(t, results{idx}.C1, 'Color', params.colors{idx}, 'LineWidth', 3);
    end
    xlabel('Time (days)','FontSize', 20);
...
hold on;
for idx = 1:length(params.N_values)
    plot(t, results{idx}.C2, 'Color', params.colors{idx}, 'LineWidth', 3);
end
...
hold on;
for idx = 1:length(params.N_values)
    plot(t, results{idx}.C3, 'Color', params.colors{idx}, 'LineWidth', 3);
end
xlabel('Time (days)','FontSize', 30);
...
hold on;
for idx = 1:length(params.N_values)
    plot(t, results{idx}.C4, 'Color', params.colors{idx}, 'LineWidth', 3);
end
xlabel('Time (days)','FontSize', 20);
ylabel('$\int_0^t \mathcal{D}_N^{(4)}(s)\,ds$', 'Interpreter','latex', 'FontSize', 20);
grid on;
...
xlabel('Time (days)','FontSize', 30);
ylabel('$\int_0^t \mathcal{D}_N^{(5)}(s)\,ds$', 'Interpreter','latex', 'FontSize', 20);
grid on;
