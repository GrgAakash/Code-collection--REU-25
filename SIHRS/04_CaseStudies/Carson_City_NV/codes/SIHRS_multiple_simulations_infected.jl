...
function sihrs_multiple_simulations_infected()
    ...
    # Model parameters
    params = SIHRSParams(
        0.157,        # beta: infection rate (β > 0) - Updated for Carson City, NV
        0.127,        # gamma: I transition rate (γ > 0) - Updated for Carson City, NV
        ...
        620,        # tmax: simulation end time (extended for Carson City, NV data)
...
function plot_multiple_simulations_infected(all_results, N, params::SIHRSParams)
    ...
    try
        ...
        daily_deaths_data = CSV.read("carson_city_daily_deaths.csv", DataFrame)
    ...
    savefig(p1, "SIHRS_Carson_City_Full_Pandemic_bandwidth.png")
    ...
    savefig(p2, "SIHRS_Carson_City_Full_Pandemic_trajectories.png")
    ...
    savefig(p3, "SIHRS_Carson_City_Full_Pandemic_active_deaths.png")
    ...
    savefig(p4, "SIHRS_Carson_City_Full_Pandemic_cumulative_deaths.png")
end
