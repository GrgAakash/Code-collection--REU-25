function SIHRS_multiple_simulations_infected_aug02()
% SIHRS model for Carson City (Aug 2020-Dec 2021) starting from Aug 2, 2020 with stochastic simulations
   ...
   params = struct(...
        ...
        'tmax', 480,        ... % simulation end time (reduced from Aug 2, 2020 to Dec 31, 2021)
    ...
    try
        fprintf('Running %d stochastic simulations for N = %d starting from Aug 2, 2020...\n', num_simulations, N);
...
function plot_multiple_simulations_infected(all_results, N, params)
    ...
    start_date_real = datetime('2020-08-02');  % Updated start date
    ...
    try
        ...
        daily_deaths_data = readtable('carson_city_daily_deaths_aug02.csv');
    ...
    title('Carson City, NV (Starting Aug 2, 2020)');
    xlim([0, params.tmax]);
    ...
    saveas(gcf, 'SIHRS_Carson_City_Aug02_Pandemic_bandwidth.png');
    ...
    saveas(gcf, 'SIHRS_Carson_City_Aug02_Pandemic_trajectories.png');

    % --- 7. Create a figure for cumulative death proportion ---
    ...
    saveas(gcf, 'SIHRS_Carson_City_Aug02_Pandemic_cumulative_deaths.png');
end
